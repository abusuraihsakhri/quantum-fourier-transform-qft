...
class AuditTrail:
    ...
    def __init__(self, secret_key: Optional[str] = None):
        ...
        if len(resolved_key) < 16:
            raise ValueError("AUDIT_SECRET_KEY must be at least 16 characters for security")
...
def _get_global_audit() -> AuditTrail:
    """Lazy initialization of global audit trail."""
    if not hasattr(_get_global_audit, "_instance"):
        _get_global_audit._instance = AuditTrail()
    return _get_global_audit._instance
