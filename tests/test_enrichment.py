"""
Automated Pytest for quantum-fourier-transform-qft Enrichment Modules.
"""
import sys
...
from enrichment import (
    ApproximateQftWithSelectiveRotationPruningEngine,
...
def test_enrichment_suite_execution():
    suite = QuantumfouriertransformqftEnrichmentSuite()
